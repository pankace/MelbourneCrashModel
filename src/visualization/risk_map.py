...
# Boston: CITY_POS = [42.3601, -71.0589]
CITY_POS = [42.3600825, -71.0588801]
CITY = 'boston'
...
DATA_FP = BASE_DIR + '/data/' + CITY + '/processed/'
MAP_FP = BASE_DIR + '/data/' + CITY + '/processed/maps/'
...
boston_map = folium.Map(CITY_POS, tiles='Cartodb dark_matter', zoom_start=12)
